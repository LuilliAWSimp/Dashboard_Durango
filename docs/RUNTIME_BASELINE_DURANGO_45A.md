# Línea base de runtime — Durango — Incremental 45A
...
- Archivos alcanzables desde `main.jsx`: **83**.
- Código JS/TS/JSX/TSX alcanzable: **64**.
...
```powershell
python .\tools\audit_runtime_baseline.py --incremental 45A --write .\docs\RUNTIME_BASELINE_DURANGO_45A.md
```
