...
export default function RevisionDiariaSection() {
  ...
  return <>
    ...
    <section className="cards-grid stagger-grid">
      <KpiCard label="Volumen validado" value={total === null ? 'No disponible' : fmt(total)} unit={total === null ? '' : 'm³'} trend="Incluye incrementos validados" accent="cyan" />
      ...
      <KpiCard label="Volúmenes validados" value={String(Math.max(0, rows.length - review))} unit="elementos" trend="Datos aceptados para operación" accent="brown" />
    </section>
