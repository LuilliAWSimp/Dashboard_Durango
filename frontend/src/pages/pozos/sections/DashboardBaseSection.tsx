  ...
  return (
    <>
      ...
      <section className="cards-grid stagger-grid summary-operational-kpis">
        ...
        <KpiCard label="Volumen validado de flujos auxiliares" value={fmt(flows.total_m3)} unit={number(flows.total_m3) === null ? '' : 'm³'} trend={volumeTrend(flows, 3)} accent="indigo" />
        ...
        <KpiCard label="Flujos auxiliares con flujo actual" value={`${Number(flows.current_flow_count || 0)}/3`} unit="elementos" trend="Lectura actual y comunicación válida" accent="teal" />
