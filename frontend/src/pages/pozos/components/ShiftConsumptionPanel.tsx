        ...
        <div className="shift-summary-cards">
          {data.shifts.map((shift) => {
            ...
            const summaryText = selectedIdentity !== undefined
              ...
              : groupSummary ? `Con actividad ${groupSummary.active_count} · Sin actividad ${groupSummary.inactive_count} · En revisión ${groupSummary.review_count}` : 'Pozos, Líneas y Flujos';
