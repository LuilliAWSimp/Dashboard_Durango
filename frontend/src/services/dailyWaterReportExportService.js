...
export function buildDailyWaterReportHtml(report, logoUrl) {
  ...
  return `<!doctype html><html lang="es"><head><meta charset="utf-8" /><title>${escapeHtml(fileTitle)}</title><style>
    ...
    <section class="kpis"><div class="kpi"><div class="kpi-label">Pozos periodo</div><div class="kpi-value">${format(entry.total_pozos_m3)} m³</div></div><div class="kpi"><div class="kpi-label">Lavadoras/Jarabes periodo</div><div class="kpi-value">${format(consumption.total)} m³</div></div><div class="kpi"><div class="kpi-label">Total entrada</div><div class="kpi-value">${format(entry.total_entrada_m3)} m³</div></div></section>
